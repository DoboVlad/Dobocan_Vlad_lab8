...
namespace Dobocan_Vlad_lab8.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Dobocan_Vlad_lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Dobocan_Vlad_lab8Context context,
